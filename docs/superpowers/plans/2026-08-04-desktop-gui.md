...
**Files:** Modify `package.json`, create `tsconfig.desktop.json`, `src/desktop/main.ts`, `src/desktop/preload.ts`, `src/desktop/ui/index.html`, `electron-builder.yml`
...
```bash
git add src/desktop/ipc.ts src/desktop/preload.ts
